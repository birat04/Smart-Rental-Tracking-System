<div align="center">
  <img src="public/cat-rental-logo.svg" width="96" height="96" alt="Caterpillar Smart Rental Intelligence Logo" />
  <h1>Caterpillar Smart Rental Intelligence System</h1>
  <p><strong>From Rental Tracking to Rental Intelligence</strong></p>
  <p><em>An industrial-grade enterprise fleet intelligence control tower engineered for heavy equipment rental operations.</em></p>
</div>
...
| `/help` | **Documentation & Support** | Comprehensive operational documentation, FAQ directory, and technical support desk. |
...
1. **Simulated Financial Ledger**: All simulated cost avoidance metrics, rental overrun penalties, and ROI computations rendered in the Analytics and AI Action Center are algorithmic projections derived from baseline telemetry rates. They serve as operational decision-support estimates.
2. **Telematics & Sensor Integration**: Sensor polling frequencies, engine runtime meters, and geofencing coordinates rely on connectivity with onboard telematics hardware (such as Cat Product Link™ / ISO 15143-3 feeds). Network interruptions or hardware latency may impact real-time synchronization.
3. **Automated Reassignments**: Equipment dispatch recommendations generated by the AI Action Center require authorized fleet operator sign-off and on-site pre-shift safety verification before physical transport.
